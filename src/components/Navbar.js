    ...
    return (
        ...
        <div className="flex justify-between items-center max-h-[15vh]">
            ...
            {/* <div className="text-right"> */}
                ...
                <Link to="/" ><img src="https://files.catbox.moe/yig64s.png" alt='logo' className="w-56 px-4 py-2 "></img></Link>
            {/* </div> */}

            <div className=" flex items-center py-3 relative">
                <ul className="hidden md:flex px-2 lg:px-0 ">
                    ...
                    <Dropdown/> {/* visible once logged in */}
                    {/* Visible when not logged in */}
                    {/* <button className="invisible sm:visible drop-shadow-xl font-['Manrope'] mr-1 px-4 py-2 border rounded-lg font-bold text-[#003247] 
        ...
        <div className={mobMenu? 'md:hidden ease-in-out duration-500  overflow-y-hidden absolute left-0 navMobile bg-[#003247] h-screen w-full z-20 px-5 py-8' : 'absolute left-[-100%] h-screen ease-in-out duration-500'}>
                <ul className="m-auto px-5 py-8">
                        ...
                        {/* Will be disable once the user is logged in i.e. visible only when not logged in */}
